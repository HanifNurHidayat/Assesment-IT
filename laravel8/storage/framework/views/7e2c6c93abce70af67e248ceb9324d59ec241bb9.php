            ...
            <div class="col-10"></div>
                <div class="coll-2 mt-5">
                    <div class="block-header block-header-default flex-row-reverse px-0 pt-0">
                        <a href="<?php echo e(route('karyawan.create')); ?>" class="btn btn-sucess">
            ...
            <tbody>
                <?php $__currentLoopData = $cvk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $karyawan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url('data_karyawan/edit/'.$karyawan->id)); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                            <a href="" class="btn btn-danger" onclick="deleteData('<?php echo e($karyawan->id); ?>')"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
...
</html><?php /**PATH D:\Project\laravel8\resources\views/data_karyawan.blade.php ENDPATH**/ ?>